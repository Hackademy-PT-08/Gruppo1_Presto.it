                ...
                <div class="col">
                  <div class="card position-relative h-100">
                    <div class="card-body p-3">
                      ...
                      <div class="d-flex align-items-center"><img class="rounded-circle me-2"
                          src="https://picsum.photos/300/300" width="36""><a class="ms-2 "
                          href="nft-catalog-v2.html">Cartzilla art collage</a></div>
                    </div>
                  </div>
                </div>
