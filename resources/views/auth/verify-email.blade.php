    ...
    <div class="container py-5 mt-5 bg-secondary shadow">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                <p class="h6  text-center text-white">Un link di verifica è stato madato al tuo indirizzo di posta
                    elettronica.</p>
                <form action="/email/verification-notification" method="post">
                    @csrf
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-8">
                            <input type="submit" class="btn btn-largr btn-primary"
                                value="Invia nuovamente il tuo link di conferma">
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="row">
          ...
          <div class="col py-4 px-4">
            ...
            <form class="form" action="/email/verification-notification" method="post">
              ...
              <div class="row gy-3">
                <div class="col-12">
                  <div class="mb-5">Ciao! Ti abbiamo inviato un link di verifica alla tua email, <b>clickalo</b>!
                  </div>
                  <div class="">COSA? Non hai ricevuto il link? Richiedi un nuovo link allora!</div>
