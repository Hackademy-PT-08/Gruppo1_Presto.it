    ...
    <div class="container mt-5">
       <div class="row">
          ...
          <div class="col-6">
            ...
            <input type="number" class="form-control my-3 @error('price') is-invalid @enderror" name="price" placeholder="Prezzo" wire:model="price" value="{{$announcement->price}}">
            <div class="error">@error('price') {{ $message }} @enderror</div>


            <select class="form-select @error('category') is-invalid @enderror" wire:model="category" name="categoria" id="categoria">
