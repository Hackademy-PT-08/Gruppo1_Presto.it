        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <textarea name="description" cols="3" rows="3" placeholder="Descrizione annuncio"
                    class="form-control my-3 @error('description') is-invalid @enderror" wire:model="description"> {{ $announcement->description }} </textarea>
                <div class="error">
                    @error('description')
                        {{ $message }}
                    @enderror
                ...
                <input type="number" class="form-control my-3 @error('price') is-invalid @enderror" name="price"
                    placeholder="Prezzo" wire:model="price" value="{{ $announcement->price }}">
                <div class="error">
                    @error('price')
                        {{ $message }}
                    @enderror
