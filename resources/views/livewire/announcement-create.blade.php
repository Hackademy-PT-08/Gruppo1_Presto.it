          ...
          <div class="col-12 col-md-8">
            <div class="row bg-light rounded-3 shadow py-3">
              ...
              <div class="col-12 mb-3">
                ...
                <input type="file" id="images" name="images" multiple class="form-control @error('temporary_images.*') is-invalid @enderror @error('images') is-invalid @enderror" wire:model="temporary_images">
                ...
                <div class="col-12">
                  ...
                  <div class="row border border-4 border-info rounded shadow py-4">
                    @foreach ($images as $key=>$image)
                      <div class="col my-3">
                        <div class="mx-auto shadow rounded preview-images" style="background-image: url({{$image->temporaryUrl()}})"></div>
